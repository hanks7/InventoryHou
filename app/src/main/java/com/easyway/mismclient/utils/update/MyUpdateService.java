...
public class MyUpdateService extends Service {
        ...
        public void run() {
            ...
            try {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    mSavePath = sdpath + BaseConstants.APP_INDEX + "/download";
                    Ulog.i("apkURL", versionMap.get("apkurl"));
                    URL url = new URL(versionMap.get("apkurl"));
    ...
    public void installApk() {
        ...
        Ulog.i("updatemanager", Uri.parse("file://" + apkfile.toString()));
