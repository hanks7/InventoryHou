...
public class PopMenu2 extends PopupWindow {
     ...
     * @param adapter
     */
    public PopMenu2(Activity activity, final View showView, View onclickView, LsvPopSelectAdapter adapter) {
    ...
    public void showPopupWindow() {
        ...
        if (!this.isShowing()) {
            ...
            int x = 0;
            int y = 0;
            showAsDropDown2(this, showView, x, y);// 以下拉方式显示popupwindow
        } else {
            this.dismiss();
        }
    }
